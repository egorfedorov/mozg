 ...
 *
 * One reader, one receipt: sharing lives a level up, where a pack purchase
 * carries seats (see lib/pack-access.ts). This stayed deliberately narrow so
 * the per-brain marketplace and the pack shelf cannot quietly become two
