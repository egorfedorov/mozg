  ...
  return (
    <>
      <input
        ...
        placeholder="What do you need to know? — filters brains by everything they can answer"
        style={{
          width: "100%",
          maxWidth: 560,
          padding: ".7rem .85rem",
      ...
      {needle && (
        <p className="mono" style={{ fontSize: ".8125rem", color: "var(--ink-2)", margin: "-1rem 0 1rem" }}>
          {shown.length} of {brains.length} brains know something about “{q.trim()}”
        </p>
      )}
          ...
          >
            ...
            <div style={{ padding: ".7rem .9rem" }}>
              <p className="mono" style={{ fontSize: ".6875rem", color: "var(--ink-3)", margin: "0 0 .5rem" }}>
                {b.access} · {b.notes.toLocaleString()} notes
