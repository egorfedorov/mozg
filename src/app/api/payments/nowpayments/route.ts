...
import { validSignature, applyWebhook, paymentsReady, completeFollowUp } from "@/lib/payments";
...
export async function POST(req: Request) {
  ...
  // Direct checkout: after the credit's transaction on purpose — both lock
  // the balance row, and nesting them would deadlock. Shared with the
  // mozgpay watcher, which settles the same way.
